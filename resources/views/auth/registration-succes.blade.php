...
<div class="min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-md w-full sm:w-96">
        ...
        <h1 class="text-2xl font-semibold mb-4">Félicitations !</h1>

        <p class="text-gray-600 mb-6">Votre inscription a bien été prise en compte. Bienvenue sur notre plateforme.</p>
